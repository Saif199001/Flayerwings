...
function Home() {
  return <div id="top" className="app-shell"><Navbar /><main>
    <section className="hero-section"><div className="hero-glow" aria-hidden="true" /><div className="hero-content"><p className="eyebrow">AI • SOFTWARE • SAAS</p><h1>Build.<br /><span>Automate.</span><br />Grow.</h1><p className="hero-copy">We build AI-powered software, SaaS products and digital solutions that help modern businesses work smarter and grow faster.</p><div className="actions"><a className="button button-primary" href="#contact">Start a Project <span>→</span></a><a className="button button-secondary" href="/tools">Explore Free Tools</a></div><div className="hero-trust"><span>AI-first delivery</span><span>Practical solutions</span><span>Built for growth</span></div></div><div className="hero-orbit" aria-hidden="true"><div className="orbit-ring ring-one" /><div className="orbit-ring ring-two" /><div className="orbit-logo"><img src="/flayer_wings_logo.jpeg" alt="" width="150" height="150" /></div></div></section>
